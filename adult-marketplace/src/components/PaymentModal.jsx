...
export default function PaymentModal({ 
  ...
  const [step, setStep] = useState(1); // 1: Select crypto, 2: Payment details, 3: Waiting
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white dark:bg-slate-800 rounded-xl p-6 flex flex-col items-center">
                <p className="text-sm font-medium text-slate-600 dark:text-slate-400 mb-4">
                  Escaneie o QR Code com sua carteira
                </p>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-blue-700 dark:text-blue-300 mt-1">
                      Envie <strong>{payment.cryptoAmount} {selectedCrypto.code. split('_')[0]}</strong> para o endereço acima
                    </p>
                  </div>
                </div>
              </div>
