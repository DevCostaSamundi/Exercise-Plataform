      ...
      <div className="flex-1 flex flex-col min-w-0">
            ...
            <div className="flex gap-2 overflow-x-auto pb-2">
              {[
                ...
                <button
                  ...
                  disabled={loading}
                  className={`px-4 py-2 rounded-lg font-medium text-sm whitespace-nowrap transition-colors ${sortBy === option.value
                    ? 'bg-black text-white'
                  ...
                  <div>
                    <label className="flex items-center gap-2">
                      <input
                        ...
                        className="w-5 h-5 text-black bg-slate-100 border-slate-300 rounded focus:ring-black"
                      />
        ...
        <div className="flex-1 overflow-y-auto">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            {/* Error */}
            {error && (
              <div className="mb-6 bg-slate-900 dark:bg-slate-900/20 border border-red-200 dark:border-red-800 rounded-lg p-4">
                ...
                {hasMore && (
                  <div className="mt-8 text-center">
                    <button
                      onClick={loadMore}
                      disabled={loading}
                      className="bg-black hover: bg-black disabled:bg-black text-white px-8 py-3 rounded-lg font-medium transition-colors"
                    >
