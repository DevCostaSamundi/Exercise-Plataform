...
const Settings = () => {
  ...
  const handleSavePersonal = async () => {
    ...
    if (!isValidEmail(personalData.email)) {
  ...
  const handleChangePassword = async () => {
    const errors = [];
    if (!securityData.currentPassword) errors.push('Informe a senha atual');
    if (!validatePassword(securityData.newPassword)) errors.push('Senha nova fraca');
    if (securityData.newPassword !== securityData.confirmPassword) errors.push('As senhas não coincidem');
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            setPersonalData({ ...personalData, displayName: e.target.value })
                          }
