...
export default function CreatorProfilePage() {
  ...
  const creator = {
    ...
    displayName: 'Luna',
    avatar: 'https://placehold.co/200x200/8B7FE8/white?text=L',
    cover: 'https://placehold.co/1200x400/6366F1/white?text=Cover',
    bio: 'Criadora de conteúdo sensual e artístico 🔥 Trans woman 🏳️‍⚧️ Posting exclusive content daily ✨ DMs open para chat personalizado 💜',
    ...
    likes: 12500,
    isSubscribed: false,
    tags: ['Trans', 'Sensual', 'Artístico', 'Fotos', 'Vídeos'],
    genderIdentity: 'Trans mulher',
    orientation: 'Lésbica',
    socialLinks: {
      instagram: 'https://instagram.com/luna.oficial',
      twitter: 'https://twitter.com/luna_oficial',
      tiktok: 'https://tiktok.com/@luna.oficial',
    },
  };

  const posts = [
    { id: 1, thumbnail: 'https://placehold.co/300x300/8B7FE8/white?text=Post1', type: 'photo', isLocked: true, likes: 342, comments: 45 },
    { id: 2, thumbnail: 'https://placehold.co/300x300/6366F1/white?text=Post2', type: 'video', isLocked: true, likes: 298, comments: 38 },
    { id: 3, thumbnail: 'https://placehold.co/300x300/A78BFA/white?text=Post3', type: 'photo', isLocked: false, likes: 267, comments: 32 },
    { id: 4, thumbnail: 'https://placehold.co/300x300/EC4899/white?text=Post4', type: 'photo', isLocked: true, likes: 234, comments: 28 },
    { id: 5, thumbnail: 'https://placehold.co/300x300/8B5CF6/white?text=Post5', type: 'video', isLocked: true, likes: 198, comments: 24 },
    { id: 6, thumbnail: 'https://placehold.co/300x300/F97316/white?text=Post6', type: 'photo', isLocked: false, likes: 176, comments: 20 },
  ];
              ...
              <div className="flex flex-col md:flex-row items-start md:items-end -mt-16 md:-mt-20">
                <div className="relative">
                  <img
                    ...
                    className="w-32 h-32 md:w-40 md:h-40 rounded-full border-4 border-white dark:border-slate-950 bg-slate-100 dark:bg-slate-900 shadow-xl"
                  />
                  {creator.isVerified && (
                ...
                <div className="flex-1 mt-4 md:mt-0 md:ml-6 md:mb-4">
                  ...
                  <div className="flex flex-wrap gap-4 text-sm">
                    ...
                    <div className="flex items-center space-x-1">
                      ...
                      <span className="font-semibold text-slate-900 dark:text-white">{formatNumber(creator.likes)}</span>
                  ...
                  {creator.isSubscribed ? (
                    ...
                    <>
                      ...
                      >
                        ...
                        <span>Assinar por {formatPrice(creator.price)}/mês</span>
                      </button>
            ...
            <div className="mt-6 space-y-4">
              ...
              <div className="flex flex-wrap gap-4 text-sm text-slate-600 dark:text-slate-400">
                ...
                <div className="flex items-center space-x-1">
                  ...
                  <span>Entrou em {creator.joined}</span>
                </div>
                <div className="flex items-center space-x-1">
                  <span>🏳️‍⚧️</span>
                  <span>{creator.genderIdentity}</span>
                </div>
                <div className="flex items-center space-x-1">
                  <span>🏳️‍🌈</span>
                ...
                <div className="flex items-center space-x-3">
                  {creator.socialLinks.instagram && (
                    <a
                      ...
                      className="p-2 bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 hover:text-pink-600 dark:hover:text-pink-400 rounded-lg transition-colors"
                    >
                  ...
                  {creator.socialLinks.twitter && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="p-2 bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 hover:text-blue-600 dark:hover:text-blue-400 rounded-lg transition-colors"
                    >
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  {creator.socialLinks.tiktok && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="p-2 bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white rounded-lg transition-colors"
                    >
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="py-8">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
                  {posts.map(post => (
                    <div key={post.id} className="relative aspect-square group cursor-pointer">
                      ...
                      {/* Locked Overlay */}
                      {post.isLocked && !creator.isSubscribed && (
                ...
                <div className="max-w-3xl space-y-6">
                  ...
                  <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 p-6">
                    ...
                    <div className="space-y-3 text-sm">
                      <div className="flex justify-between">
                        <span className="text-slate-500 dark:text-slate-400">Identidade de Gênero:</span>
                        <span className="text-slate-900 dark:text-white font-medium">{creator.genderIdentity}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-slate-500 dark:text-slate-400">Orientação:</span>
                        <span className="text-slate-900 dark:text-white font-medium">{creator.orientation}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-slate-500 dark:text-slate-400">Localização:</span>
                        <span className="text-slate-900 dark:text-white font-medium">{creator.location}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-slate-500 dark:text-slate-400">Membro desde:</span>
                        <span className="text-slate-900 dark:text-white font-medium">{creator.joined}</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 p-6">
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="text-2xl font-bold text-indigo-600 dark:text-indigo-400">{formatPrice(creator.price)}</p>
              ...
              {activeTab === 'media' && (
                <div className="text-center py-12">
                  ...
                  <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-2">Galeria de Mídia</h3>
                  <p className="text-slate-500 dark:text-slate-400 mb-6">Todos os vídeos e fotos exclusivas</p>
                  {!creator.isSubscribed && (
                    <button
                      onClick={handleSubscribe}
                      className="inline-flex items-center space-x-2 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white px-6 py-3 rounded-lg font-bold transition-all"
                    >
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                        <path fillRule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clipRule="evenodd" />
                      </svg>
                      <span>Assine para ver toda mídia</span>
                    </button>
                  )}
                </div>
              )}
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 max-w-md w-full p-6 shadow-2xl">
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-xl font-bold text-slate-900 dark:text-white">Assinar @{creator.username}</h3>
              <button
            ...
            <div className="flex items-center space-x-4 mb-6 p-4 bg-slate-50 dark:bg-slate-800 rounded-lg">
              <img src={creator.avatar} alt={creator.displayName} className="w-16 h-16 rounded-full" />
              <div className="flex-1">
                <h4 className="font-semibold text-slate-900 dark:text-white">{creator.displayName}</h4>
            ...
            <div className="bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-indigo-900/20 dark:to-purple-900/20 rounded-xl p-6 mb-6">
              <div className="flex items-baseline justify-center mb-4">
                <span className="text-4xl font-bold text-indigo-600 dark:text-indigo-400">{formatPrice(creator.price)}</span>
                <span className="text-slate-600 dark:text-slate-400 ml-2">/mês</span>
              </div>
              <ul className="space-y-2 text-sm">
                <li className="flex items-center text-slate-700 dark:text-slate-300">
                  ...
                  {creator.posts} posts exclusivos
                </li>
                <li className="flex items-center text-slate-700 dark:text-slate-300">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-green-600 mr-2" viewBox="0 0 20 20" fill="currentColor">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
            ...
            <button
              onClick={() => {
                // TODO: Integrar com checkout/pagamento
                alert('Redirecionando para o checkout...');
              }}
              className="w-full bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white font-bold py-4 rounded-lg transition-all shadow-lg hover:shadow-xl"
            >
              Assinar Agora
            </button>
