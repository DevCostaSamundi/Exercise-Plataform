        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-xl font-bold text-slate-900 dark:text-white">Meus Posts</h1>
                <p className="text-sm text-slate-500 dark:text-slate-400">{filteredPosts.length} post(s)</p>
              </div>
            </div>
