...
export default function CreatorPostsPage() {
  ...
  const getStatusBadge = (status) => {
    const badges = {
      published: { label: 'Publicado', color: 'bg-black dark:bg-white text-white dark:text-black font-semibold' },
      scheduled: { label: 'Agendado', color: 'bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400' },
      draft: { label: 'Rascunho', color: 'border border-slate-200 dark:border-slate-700 text-slate-500' },
    };
      ...
      <div className="flex-1 flex flex-col">
        ...
        <header className="bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 sticky top-0 z-10">
          <div className="w-full px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between h-16">
              ...
              <Link
                to="/creator/upload"
                className="flex items-center space-x-1 sm:space-x-2 bg-black hover:bg-black text-white font-medium px-3 sm:px-4 py-2 rounded-lg transition-colors text-sm flex-shrink-0"
              >
        ...
        {showSuccessMessage && successMessage && (
          <div className="w-full px-4 sm:px-6 lg:px-8 pt-4">
            <div className="bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-slate-800 dark:text-slate-200 px-4 py-3 rounded-lg flex items-center justify-between">
              ...
              <button onClick={() => setShowSuccessMessage(false)} className="text-slate-800 dark:text-slate-800 hover:text-slate-800 dark:hover:text-slate-800">
                ✕
              </button>
            </div>
          </div>
              ...
              <div className="flex items-center space-x-2">
                <button
                  ...
                  className={`p-2 rounded-lg transition-colors ${viewMode === 'grid'
                    ? 'bg-black dark:bg-black/20 text-black dark:text-black'
              ...
              <div className="mt-4 pt-4 border-t border-slate-200 dark:border-slate-800 flex items-center justify-between">
                <div className="flex items-center space-x-4">
                  ...
                  <button
                    ...
                    disabled={deleting}
                    className="text-sm text-slate-900 dark:text-slate-900 hover:text-slate-900 dark:hover:text-slate-900 font-medium disabled:opacity-50"
                  >
          ...
          {loading ? (
            <div className="flex items-center justify-center py-20">
              <div className="text-center">
                <div className="inline-block animate-spin rounded-full h-12 w-12 border-4 border-black dark:border-white border-t-transparent mb-4"></div>
            ...
            <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 p-12 text-center">
              ...
              <Link
                to="/creator/upload"
                className="inline-flex items-center space-x-2 bg-black hover:bg-black text-white font-medium px-6 py-3 rounded-lg transition-colors"
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                  <path fillRule="evenodd" d="M10 3a1 1 0 011 1v5h5a1 1 0 110 2h-5v5a1 1 0 11-2 0v-5H4a1 1 0 110-2h5V4a1 1 0 011-1z" clipRule="evenodd" />
                </svg>
                ...
                <div key={post.id} className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 overflow-hidden hover:shadow-lg transition-shadow group">
                  ...
                  <div className="relative aspect-square bg-slate-100 dark:bg-slate-800">
                    ...
                    <div className="absolute top-3 left-3">
                      <input
                        ...
                        className="w-5 h-5 text-black bg-white border-slate-300 rounded focus:ring-2 focus:ring-black dark:focus:ring-white cursor-pointer"
                      />
                    </div>
                  ...
                  <div className="p-4">
                    ...
                    {post.visibility === 'premium' && post.earnings > 0 && (
                      <div className="bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-lg px-3 py-2 mb-3">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <button
                        ...
                        className="p-2 text-slate-900 dark:text-slate-900 hover:bg-slate-900 dark:hover:bg-slate-900/20 rounded-lg transition-colors"
                        title="Deletar post"
                      >
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    <tr>
                      <th className="px-6 py-3 text-left">
                        <input
                          ...
                          className="w-5 h-5 text-black bg-slate-100 dark:bg-slate-700 border-slate-300 dark:border-slate-600 rounded focus:ring-2 focus:ring-black dark:focus:ring-white cursor-pointer"
                        />
                      </th>
        ...
        {showDeleteModal && postToDelete && (
          <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
            <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 max-w-md w-full p-6 shadow-2xl">
              <div className="flex items-center justify-center w-12 h-12 bg-slate-900 dark:bg-slate-900/20 rounded-full mb-4 mx-auto">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-slate-900 dark:text-slate-900" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div className="flex items-center space-x-3">
                ...
                <button
                  ...
                  disabled={deleting}
                  className="flex-1 px-4 py-3 bg-slate-900 hover:bg-slate-900 text-white font-bold rounded-lg transition-colors disabled: opacity-50 flex items-center justify-center space-x-2"
                >
                  {deleting ? (
                    <>
