            ...
            <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 p-6 space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 bg-slate-50 dark:bg-slate-800 border ${
                    errors.title ? 'border-red-300' : 'border-slate-200 dark:border-slate-700'
              ...
              <div>
                ...
                <textarea
                  ...
                  maxLength={500}
                  className={`w-full px-4 py-3 bg-slate-50 dark:bg-slate-800 border ${
                    errors.description ? 'border-red-300' : 'border-slate-200 dark:border-slate-700'
                ...
                <div className="grid grid-cols-3 gap-3">
                  <button
                    ...
                    className={`p-4 rounded-lg border-2 transition-all ${
                      formData.visibility === 'subscribers'
                  ...
                  <div className="grid grid-cols-2 gap-4 mt-4">
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full px-4 py-3 bg-slate-50 dark:bg-slate-800 border ${
                          errors.scheduledDate ? 'border-red-300' : 'border-slate-200 dark:border-slate-700'
                        } rounded-lg text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-indigo-500`}
                      />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={handleChange}
                        className={`w-full px-4 py-3 bg-slate-50 dark:bg-slate-800 border ${
                          errors.scheduledTime ? 'border-red-300' : 'border-slate-200 dark:border-slate-700'
                        } rounded-lg text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-indigo-500`}
                      />
